import { n as registerPlugin } from "./dist-CxnogeaA.js";
...
var LocalNotifications = registerPlugin("LocalNotifications", { web: () => import("./web-C0olmbVN.js").then((m) => new m.LocalNotificationsWeb()) });
//#endregion
